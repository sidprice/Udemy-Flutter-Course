...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> updateProduct(
    ...
    return http
        .put(
            'https://flutter-products-73ca0.firebaseio.com/products/${selectedProduct.id}.json',
  ...
  Future<bool> addProduct(
    ...
    try {
      final http.Response response = await http.post(
          'https://flutter-products-73ca0.firebaseio.com/products.json',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-products-73ca0.firebaseio.com/products/${deletedProductId}.json')
        .then((http.Response response) {
      _isLoading = false;
      notifyListeners();
      return true;
